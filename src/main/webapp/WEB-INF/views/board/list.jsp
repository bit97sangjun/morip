...
<%@include file="../includes/header.jsp" %>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tables <button id='registerBtn'>등록하기</button></h1>                    
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <select id='listSize' name='listSize'>
                              <option value='10' ${criteria.size == 10?"selected":""}>10</option>
                              <option value='20' ${criteria.size == 20?"selected":""}>20</option>
                              <option value='30' ${criteria.size == 30?"selected":""}>30</option>
                              <option value='40' ${criteria.size == 40?"selected":""}>40</option>
                            </select>
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                    	...
                                    	<td><a href='${board.bno}' class='target'><c:out value="${board.title}"></c:out></a> </td>
    ...
    $(document).ready(function() {
    	...
    	$(".target").on("click", function(event){
    		...
    		actionForm.attr("action","/board/detail").submit();
    	});
